...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3dhcG5pbDY3IiwiYSI6ImNrYjJoMmxtdzBiaWcyc243c3VoemJkeGsifQ.IvKDFrzWz1tFCBprjnK6Gg';
...
*/
var stripe = Stripe('pk_test_51GtBPoGidNu2wPoCIROGpYsPAe7Ts8KyzSpVHqceIMjGcnDBG71T8yzmg10t543dk9GRz9d9GIKJGCszeDmLceiM001G9C23n1');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios("http://127.0.0.1:8000/api/v1/bookings/checkout-session/".concat(tourId));
